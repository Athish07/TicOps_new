...
function AttachmentCard({ attachment }: { attachment: ChatAttachment }) {
  if (isImage(attachment.type)) {
    return (
      <a href={attachment.url} target="_blank" rel="noopener noreferrer" className="block overflow-hidden rounded-lg">
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 rounded-lg border border-current/10 bg-current/5 px-3 py-2 text-sm transition hover:bg-current/10"
    >
